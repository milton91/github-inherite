            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        @else
                            <x-nav-link href="/login" class="px-3 py-2 text-sm font-medium text-gray-500 bg-white hover:text-gray-700">
                                Login
                            </x-nav-link>
                            <x-nav-link href="/register" class="px-3 py-2 text-sm font-medium text-gray-500 bg-white hover:text-gray-700">
                                Register
                            </x-nav-link>
                        @endauth
                    </x-slot>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                @auth
                    <!-- Wishlist and Sell Item Links for Mobile -->
                    <x-responsive-nav-link href="/wishlist">
                        Wishlist
                    </x-responsive-nav-link>
                    <x-responsive-nav-link href="/sell">
                        Sell Item
                    </x-responsive-nav-link>
